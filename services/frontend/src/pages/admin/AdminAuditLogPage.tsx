...
const ACTION_OPTIONS = [
  ...
  { value: 'ong.approve', label: 'Aprovar ONG' },
  { value: 'ong.reject', label: 'Rejeitar ONG' },
  { value: 'ong.deactivate', label: 'Desativar ONG' },
  { value: 'ong.reactivate', label: 'Reativar ONG' },
  { value: 'volunteer.create', label: 'Criar Voluntário' },
  { value: 'volunteer.update', label: 'Editar Voluntário' },
  { value: 'volunteer.deactivate', label: 'Desativar Voluntário' },
  { value: 'volunteer.reactivate', label: 'Reativar Voluntário' },
  { value: 'volunteer.remove', label: 'Remover Voluntário' },
];
    ...
    <div>
      ...
      <Row gutter={[16, 16]} style={{ marginBottom: 24 }}>
        <Col xs={24} sm={12} md={6}>
          <Input
            placeholder="Filtrar por usuário (nome)"
            allowClear
